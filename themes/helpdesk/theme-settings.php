 ...
 *   The form state.
 */
function helpdesk_form_system_theme_settings_alter(&$form, &$form_state) {
    
    $form['st_settings'] = array(
        '#type' => 'fieldset',
        '#title' => t('ST HelpDesk Theme Settings'),
        '#collapsible' => FALSE,
        '#collapsed' => FALSE,
    );
    ...
    $form['st_settings']['tabs']['basic_settings']['scrolltop_display'] = array(
        ...
        '#default_value' => theme_get_setting('scrolltop_display', 'helpdesk'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
    );
    ...
    $form['st_settings']['tabs']['basic_settings']['bootstrap_js_include'] = array(
        ...
        '#default_value' => theme_get_setting('bootstrap_js_include', 'helpdesk'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
    );
    ...
    $form['st_settings']['tabs']['ie8_support']['responsive_respond'] = array(
        '#type' => 'checkbox',
        '#title' => t('Add Respond.js [<em>helpdesk/js/respond.min.js</em>] JavaScript to add basic CSS3 media query support to IE 6-8.'),
        '#default_value' => theme_get_setting('responsive_respond','helpdesk'),
